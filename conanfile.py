...
class TeiaCareImage(ConanFile):
    name = "teiacare_image"
    version = get_project_version()
    license = "Apache License"
    author = "TeiaCare"
    url = "https://github.com/TeiaCare/TeiaCareImage"
    description = "TeiaCareImage is a collection of C++ image processing utilities"
    topics = ("image")
    exports = "VERSION"
    exports_sources = "CMakeLists.txt", "README.md", "VERSION", "cmake/*", "image/CMakeLists.txt", "image/include/*", "image/src/*"
    ...
    def package_info(self):
        self.cpp_info.libs = ["teiacare_image"]
        self.cpp_info.set_property("cmake_file_name", "teiacare_image")
        self.cpp_info.set_property("cmake_target_name", "teiacare::image")
